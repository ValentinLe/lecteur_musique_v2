...
public class DashboardController implements Initializable, DashboardListener {
	...
	// on ajoute le controller comme listener du model et qui ecoutera les changements
	dashboard.addListener(this);
	isPlaying = false;
	isPauseChangeValue = false;

	// on recupere le dossier contenant les musiques indiquer dans les configurations
	...
	// empecher que la barre de recherche soit focus des l'ouverture de l'application
    ...
    /**
     * Met en pause la lecture quand elle est en cours ou met play si elle est
     * en pause
     *
    ...
    /**
     * Change l'etat de lecture de la musique, met en pause quand elle est en
     * play et inversement
     */
    ...
    /**
     * Met la lecture en play la lecture en changeant le logo du boutton
     * playPause
     */
    private void play() {
	play(true);
     ...
     * logo play sur le boutton (pour le seek quand on deplace le slider de la
     * position)
     */
     ...
     *
     * @param turnButton true si on affiche le logo play, false si on laisse le
     * logo pause sur le boutton
     */
    ...
    /**
     * Active ou desactive le loop de la musique courrante et ajoute un
     * affichage sur le bouton pour indiquer si il est locker ou non
     */
    @FXML
    private void loop() {
	looping = !looping;
    ...
    /**
     * Affiche le bouton comme locker/delocker en y ajoutant/retirant une classe
     * CSS
     *
     ...
     * slider (probeme avec le click qui est detecte mais la boule du slider ne
     * se deplace pas)
     *
	...
	if (currentMusic != null) {
	    ...
	    // ajout du listener sur la lecture de la musique qui changera la valeur du slider de position au fur et a mesure de la lecture
