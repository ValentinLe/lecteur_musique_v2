package fr.valentinle.lecteur_musique.config;
...
public class Config {
     ...
     * @return le nom absolue du fichier de configuration ou null si il n'a pas ete
     *         trouve
     */
     ...
     * 
     * @param newConfigFileName le nouveau fichier de configuration a prendre en
     *                          compte
